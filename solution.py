...
class LeaderBoard(object):
    ...
    def _record_result(self, match):
        ...
        if score1 == score2:
            self._record_tie(self.teams[self.teams.index(team1)])
            self._record_tie(self.teams[self.teams.index(team2)])
        else:
...
def main():
    ...
    for line in get_input():
        leader_board.record_result(line)
